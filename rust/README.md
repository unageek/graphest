...
| `abs(x)` or `\|x\|`                                          | \|*x*\|                                                      |                                                              |
| `min(x1, …, xn)`<br />`max(x1, …, xn)`                       | min {*x*<sub>1</sub>, …, *x*<sub>*n*</sub>}<br />max {*x*<sub>1</sub>, …, *x*<sub>*n*</sub>} | The minimum/maximum of the set {*x*<sub>1</sub>, …, *x*<sub>*n*</sub>}. |
| `ranked_min([x1, …, xn], k)`<br />`ranked_max([x1, …, xn], k)` |                                                              | The *k*th smallest/largest value in the list (*x*<sub>1</sub>, …, *x*<sub>*n*</sub>). |
...
| `sign(x)` or `sgn(x)`                                        | sgn(*x*)                                                     | The [sign function](https://en.wikipedia.org/wiki/Sign_function). |
