...
|https://functions.wolfram.com/ElementaryFunctions/ProductLog/[MFS]
https://mathworld.wolfram.com/LambertW-Function.html[MW] +
https://functions.wolfram.com/ElementaryFunctions/ProductLog2/[MFS]
https://mathworld.wolfram.com/LambertW-Function.html[MW]
...
|https://functions.wolfram.com/GammaBetaErf/InverseErf/[MFS]
https://mathworld.wolfram.com/InverseErf.html[MW]

|`erfcinv(x)`
|stem:[\operatorname{erfc}^{-1}(x)]
|The inverse complementary error function.
|https://functions.wolfram.com/GammaBetaErf/InverseErfc/[MFS]
